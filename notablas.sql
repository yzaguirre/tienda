...
DROP TABLE administradores PURGE;
DROP TABLE tarjetas_red PURGE;
DROP TABLE modelos_disco PURGE;
DROP TABLE modelos_placa PURGE;
DROP TABLE tarjetas_video PURGE;
